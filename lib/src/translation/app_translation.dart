...
final Map<String, String> enUS = {
  ...
  'homePageRank': 'Rank',
  'homePagePatch': 'Patch',
  'favoritesDialogDiscordTitle': 'Join the DB Mini discord community!',
  'favoritesDialogDiscordButton': 'Discord Invitation',
  'favoritesDialogGitHubTitle':
      "Discover Charles Lana's portfolio and projects",
  'favoritesDialogGitHubButton': 'Visit GitHub',
  'favoritesDialogNewsTitle': 'News DB Mini',
  'favorites': 'Favorites',
...
final Map<String, String> ptBR = {
  ...
  'favoritesDialogDiscordTitle': 'Entre na comunidade do discord do DB Mini!',
  'favoritesDialogDiscordButton': 'Convite do Discord',
  'favoritesDialogGitHubTitle':
      'Conheça o portfólio e projetos do Charles Lana',
  'favoritesDialogGitHubButton': 'Visitar o GitHub',
  'favoritesDialogNewsTitle': 'Notícias DB Mini',
  'favorites': 'Favoritos',
  'favoritesTabDecks': 'Decks (@value)',
  'favoritesTabMinis': 'Minis (@value)',
...
final Map<String, String> esES = {
  ...
  'favoritesDialogDiscordTitle': '¡Únete a la comunidad de DB Mini Discord!',
  'favoritesDialogDiscordButton': 'Invitación de Discord',
  'favoritesDialogGitHubTitle':
      'Descubra la cartera y los proyectos de Charles Lana',
  'favoritesDialogGitHubButton': 'Visita GitHub',
  'favoritesDialogNewsTitle': 'Noticias DB Mini',
  'favorites': 'Favoritos',
