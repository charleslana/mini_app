...
final Map<String, String> esES = {
  ...
  'utilsDialogNameDeckInputEmpty': 'Por favor ingrese el nombre de su deck',
  'utilsDialogNameDeckInputMaxCharacters':
      'El nombre de la deck debe contener un máximo de 30 caracteres.',
  ...
  'favoritesDeckNotFound': 'No se encontraron decks favoritos.',
  'favoritesDeckNewDeck': 'Nueva Deck',
  'favoritesDeckDialogTitle': 'Eliminar',
  'favoritesDeckDialogMiddleText':
      '¿Estás seguro de que quieres eliminar la deck?',
  'favoritesDeckDialogTextConfirm': 'Ok',
  'favoritesDeckDialogTextCancel': 'Cancelar',
  'formDeckPageCreateDeck': 'Crea una nueva deck',
  'formDeckPageEditDeck': 'Editar deck',
  'formDeckPageSaveDeck': 'Guardar deck',
  ...
  'formDeckDialogTextConfirm': 'Ok',
  'formDeckDialogMiddleText':
      'No has terminado todo el deck, ¿de verdad quieres dejarlo?',
